...
This is a CRAN submission for the (new) R package pvLRT 0.2.2, which provides a suite of functions implementing likelihood ratio test-based approaches to pharmacovigilance. We have ensured that all examples take < 10s time to pass the CRAN check in this version. (One example failed this test during the initial CRAN submission of v0.2.0.) 

In addition, we have taken into account all the helpful comments and suggestions provided by Gregor Seyer on behalf of CRAN during the submission of pvLRT v0.2.1. We greatly appreciate the comments; we have made all the necessary changes in v0.2.2, and our point-by-point responses are provided below.
...
--> Response: Thanks for the suggestion. In v0.2.2, we have updated the DESCRIPTION with an appropriately populated Authors@R filed.              
...
--> Response: Thank you for the suggestion. In pvLRT v0.2.2, we have added 
