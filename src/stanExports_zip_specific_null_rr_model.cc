...
#include "stanExports_zip_specific_null_rr_model.h"

RCPP_MODULE(stan_fit4zip_specific_null_rr_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_zip_specific_null_rr_model")
